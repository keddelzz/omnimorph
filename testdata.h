...
template<>
struct CopyGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<float, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<float, Vac3_Repr_2>;
    using Vac3_Repr_0 = HList<float, Vac3_Repr_1>;
    using Vac3_Repr   = Vac3_Repr_0;
    ...
    static Repr to(const Type &value) {
        ...
        const Vac3_Repr_2 tl2(value.c, tl3);
        const Vac3_Repr_1 tl1(value.b, tl2);
        const Vac3_Repr_0 tl0(value.a, tl1);
        return tl0;
    }
    ...
    static Type from(const Repr &repr) {
        ...
        const auto tl2 = tl1.tail;
        const auto tl3 = tl2.tail;
        return Vac3(tl0.head, tl1.head, tl2.head);
    }
};

template<>
struct LabelledCopyGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<MemberValue<float>, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<MemberValue<float>, Vac3_Repr_2>;
    using Vac3_Repr_0 = HList<MemberValue<float>, Vac3_Repr_1>;
    using Vac3_Repr   = Vac3_Repr_0;
    ...
    static Repr to(const Type & value) {
        ...
        const Vac3_Repr_0 tl0(member_value(value, a), tl1);
        return tl0;
    }
    ...
    static Type from(const Repr &repr) {
        ...
        const auto tl2 = tl1.tail;
        const auto tl3 = tl2.tail;
        return Vac3(tl0.head.value, tl1.head.value, tl2.head.value);
    }
};

template<>
struct ReferenceGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<float &, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<float &, Vac3_Repr_2>;
...
template<>
struct LabelledReferenceGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<MemberReference<float>, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<MemberReference<float>, Vac3_Repr_2>;
    using Vac3_Repr_0 = HList<MemberReference<float>, Vac3_Repr_1>;
    using Vac3_Repr   = Vac3_Repr_0;
    ...
    static Repr to(Type &value) {
        const Vac3_Repr_3 tl3{};
        const Vac3_Repr_2 tl2(member_reference(value, c), tl3);
        const Vac3_Repr_1 tl1(member_reference(value, b), tl2);
        const Vac3_Repr_0 tl0(member_reference(value, a), tl1);
        return tl0;
    }
};

template<>
struct PointerGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<float *, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<float *, Vac3_Repr_2>;
...
template<>
struct LabelledPointerGeneric<Vac3>
{
    using Vac3_Repr_3 = HNil;
    using Vac3_Repr_2 = HList<MemberPointer<float>, Vac3_Repr_3>;
    using Vac3_Repr_1 = HList<MemberPointer<float>, Vac3_Repr_2>;
    using Vac3_Repr_0 = HList<MemberPointer<float>, Vac3_Repr_1>;
    using Vac3_Repr   = Vac3_Repr_0;
    ...
    static Repr to(Type &value) {
        const Vac3_Repr_3 tl3{};
        const Vac3_Repr_2 tl2(member_pointer(value, c), tl3);
        const Vac3_Repr_1 tl1(member_pointer(value, b), tl2);
        const Vac3_Repr_0 tl0(member_pointer(value, a), tl1);
        return tl0;
    }
};
